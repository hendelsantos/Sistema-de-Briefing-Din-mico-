    ...
    <div className="min-h-screen bg-slate-50 font-sans selection:bg-indigo-100 selection:text-indigo-900">
      ...
      <header className="bg-white border-b border-slate-200">
        <div className="max-w-4xl mx-auto px-6 h-20 flex items-center justify-between">
          <Link href="/" className="text-xl font-bold tracking-tight text-slate-900">
             Hendel<span className="text-indigo-600">Code</span>
          </Link>
      ...
      <main className="max-w-4xl mx-auto px-6 py-12">
          ...
          <div className="p-8 md:p-12">
            ...
            <div className="mt-12 pt-12 border-t border-slate-100 flex flex-col md:flex-row items-center justify-between gap-6">
              <div className="text-center md:text-left">
                <p className="font-medium text-slate-900">Dúvidas?</p>
                <p className="text-slate-500 text-sm">Entre em contato direto comigo.</p>
              </div>
              <a
                href={`https://wa.me/5519974212216?text=${whatsappMessage}`}
                target="_blank"
                className="bg-green-600 hover:bg-green-700 text-white text-lg font-bold py-4 px-10 rounded-xl shadow-lg hover:shadow-xl transition-all transform hover:-translate-y-1 w-full md:w-auto text-center flex items-center justify-center gap-2"
              >
        ...
        <details className="bg-white rounded-lg border border-slate-200 shadow-sm overflow-hidden group">
          <summary className="px-6 py-4 cursor-pointer font-medium text-slate-700 flex justify-between items-center group-open:bg-slate-50 transition-colors">
